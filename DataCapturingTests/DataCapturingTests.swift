    ...
    */
    ...
    func testLifecyclePerformance() throws {
        ...
        measure {
            ...
            for i in 0...99 {
                oocut.accelerationsCache.append(SensorValue(timestamp: Date(timeInterval: TimeInterval(Int64(i)), since: Date(timeIntervalSince1970: TimeInterval(10_000))), x: 1.0, y: 1.0, z: 1.0))
            }
