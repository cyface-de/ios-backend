...
let carString = NSLocalizedString("car",
                                  comment: "User may select car as the vehicle of choice!")
let bikeString = NSLocalizedString("bike",
                                   comment: "User may select bicycle as the vehicle of choice!")
let motorbikeString = NSLocalizedString("motorbike", comment: "User may select a motorbike as the vehicle of choice!")
let nothingSelectedAlertTitle = NSLocalizedString("nothingSelectedAlertTitle",
                                                  comment:
"""
...
""")
let nothingSelectedAlertMessage = NSLocalizedString("nothingSelectedAlertMessage",
                                                    comment:
"""
...
let noLocationSelectedTitle = NSLocalizedString("noLocationSelectedTitle",
                                                comment:
"""
Displayed on an alert notification, during the process of adding a new modality type, if no location was selected!
""")
let noLocationSelectedMessage = NSLocalizedString("noLocationSelectedMessage",
                                                  comment:
"""
...
let okAction = NSLocalizedString("okAction",
                                 comment: "Shown to acknowledge an alert dialog!")
