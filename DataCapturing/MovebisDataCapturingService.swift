...
public class MovebisDataCapturingService: DataCapturingService {
    ...
    */
    public override init(connection serverConnection: CyfaceServerConnection, sensorManager manager: CMMotionManager, updateInterval interval: Double, persistenceLayer persistence: PersistenceLayer) {
